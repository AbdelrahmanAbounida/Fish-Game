...
class Fish {    
    constructor(){
        ...
        this.enemyCrashsound = {
            ...
            middle: [crashSound('assets/middle.ogg'),crashSound('assets/middle2.ogg')],
    ...
    update(){
        ...
        // update type 
        this.type = gameScore < this.smallSize ? 'small' : gameScore < this.middleSize ? 'middle' : 'big';
        // update scale 
        this.currentScale = gameScore < this.smallSize ? this.smallScale : gameScore < this.middleSize ? this.middleScale : this.bigScale;
        // update shiftX,Y
        this.shifY = gameScore < this.smallSize ? 55 : gameScore < this.middleSize ? 90 : 120;
        this.shifX = gameScore < this.smallSize ? 60 : gameScore < this.middleSize ? 90 : 125;
        this.radius = gameScore < this.smallSize ? 42 : gameScore < this.middleSize ? 65 : 85;
        ...
        // update live stars
        this.currentLiveImages = this.lives == 3 ? this.fullLiveImages : this.lives == 2? this.middleLiveImages: this.oneLiveImages;
                ...
                switch(gameobject.type){
                    case 0:  // big enemy   
                            ...
                            // eat enemy 
                                ...
                                this.enemyCrashsound.big[0].play();gameScore+=7; 
                                gameEnemies.splice(objectPos,1);   
                            }    
                            break;
                    case 1: // middle enemy
                            ...
                            // eat enemy 
                                ...
                                this.enemyCrashsound.middle[Math.floor(Math.random()*2)].play();gameScore+=5;
                                gameEnemies.splice(objectPos,1);  
                            }
                            break;
                    
                    case 2: // eat enemy 
                            this.enemyCrashsound.small[Math.floor(Math.random()*2)].play();gameScore+=3;
                            gameEnemies.splice(objectPos,1);
                            break; // small enemy
                }
...
class Enemy {
    constructor(){
        ...
        this.currentScale = this.type == 0 ? this.bigScale : this.type == 1 ? this.middleScale : this.smallScale;
        this.currentRadius = this.type == 0 ? this.radius.big : this.type == 1 ? this.radius.middle : this.radius.small;
...
class Bubble{
    constructor(color){
        ...
        this.color = color;  
        this.img = createImage('assets/sprites/bubble/bubble_pop_two/buble_pop_two_01.png');
    }
    // vertical motion
    move(){
...
function generateSeeSurface(){
    ...
    // seeSurfaceBackGround1
    ctx.drawImage(
        seeSurfaceBackGround.img,
        seeSurfaceBackGround.x1,
        seeSurfaceBackGround.y,
        seeSurfaceBackGround.width,
        seeSurfaceBackGround.height
    );

    // seeSurfaceBackGround2
    ctx.drawImage(
        seeSurfaceBackGround.img,
        seeSurfaceBackGround.x2,
        seeSurfaceBackGround.y,
        seeSurfaceBackGround.width,
        seeSurfaceBackGround.height
    );
...
var SeaBedBackGround = {
    imgs:[
        createImage('assets/sprites/seabed9.png'),
        createImage('assets/sprites/seabed9.png'),
        createImage('assets/sprites/seabed5.jpg'),
        createImage('assets/sprites/seabed5.jpg'),
...
function generateSeaBedBackGround(){
    ...
    if(SeaBedBackGround.x1 < -canvas.width) SeaBedBackGround.x1 = 0;
    if(SeaBedBackGround.x2 < 0) SeaBedBackGround.x2 = canvas.width;
